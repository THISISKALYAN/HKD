export const MOCK_BLOGS = [
  {
    ...
    createdAt: "October 18, 2026",
    excerpt: "Deepotsav celebrates the sacred month of Kartik. Throughout Braj, devotees offer ghee lamps to Lord Krishna and Srimati Radharani, filling temples with radiant spiritual devotion.",
...
We warmly invite you, your family, and your friends to visit Hare Krishna Mandir Dehradun during Kartik Deepotsav, offer a lamp of love to Lord Damodara, and illuminate your spiritual journey with everlasting peace and bliss.`
  },
  {
    ...
    excerpt: "Commemorating the golden avatara, Sri Chaitanya Mahaprabhu, who inaugurated the Hare Krishna Sankirtana movement for the spiritual elevation of all souls.",
    coverImage: "https://hkmguwahati.org/wp-content/uploads/2026/02/720x480_GP.png",
    published: true,
    content: `SRI GAURA PURNIMA: THE APPEARANCE DAY OF SRI CHAITANYA MAHAPRABHU
...
You can become an active part of this noble mission by adopting a cow, sponsoring daily fodder and jaggery, or contributing toward Gaushala medical infrastructure. Serving Gau Mata brings divine peace, good health, and family prosperity.`
  },
  {
    ...
    coverImage: "https://recovered.sfo3.cdn.digitaloceanspaces.com/media/15844/Anxiety-disorders-(1).jpg?v=1722503273",
    published: true,
