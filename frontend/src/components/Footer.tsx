...
export function Footer() {
  ...
  return (
    <footer className="relative bg-white pt-8 pb-4 overflow-hidden border-t border-gray-100 font-sans">
      ...
      {/* ── Background Temple (Clear & Crisp Artwork) ── */}
      ...
      <div className="hidden md:block absolute top-0 right-0 bottom-0 z-0 pointer-events-none select-none" style={{ width: '500px' }}>
